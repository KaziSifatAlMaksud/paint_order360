    ...
    <div class="container">
        ...
        <div class="card" style="padding: 10px 10px 0px 10px; background-color: #fff9c6;">
            ...
            <p class="text-left reduced-line-height showinline">
                ...
                {{-- Check if users and assignedJob are set, and the assigned_painter matches the logged-in user --}}
            ...
            <p class="text-left reduced-line-height showinline">
                <b>Job Description: </b>
                {{-- Check and display builder_company_name if it exists --}}
                ...
                {{-- Check if assignedJob is set and matches the logged-in user, then display its description --}}
