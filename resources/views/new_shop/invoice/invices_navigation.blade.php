                ...
                <div class="row">
                    <div class="col-7">
                        ...
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                            @if($totalLateInvoices) {{ $totalLateInvoices }} @else 0 @endif
                        </span>
                    </div>
                    {{-- <div class="col-10">
                        <h4 style="text-align: left; color:black;"><b> Late Invoices </b></h4>
...
<a href="<?php echo '/invoices/send_statement' ?>" class="dueInvoice-link" id="newInvoice-link">
    <div class="docs_part docs_prt1">
        <div class="docs_left jobs_cnt">
            <div class="row">
                <div class="col-10">
                    <h4 style="text-align: left; color:black;"><b> Send statement </b></h4>
                </div>
            </div>
...
<a href="<?php echo '/invoices/report' ?>" class="dueInvoice-link" id="newInvoice-link">
    <div class="docs_part docs_prt1">
        <div class="docs_left jobs_cnt">
            <div class="row">
                <div class="col-10">
                    <h4 style="text-align: left; color:black;"><b> Reports & Statements </b></h4>
                </div>
            </div>
