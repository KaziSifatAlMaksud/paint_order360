    ...
    <section>
        <div class="card-area">
            ...
            <div class="card-row">
                ...
                <div class="card-header {{ $order->type == 'inside' ? 'card-header-inside' : '' }}" style=" margin-bottom: 5px;">


                    <h3 style="font-size: large; font-weight: bold;">{{ $key }} :</h3>
                    <div class="card-part2 {{ $order->type == 'inside' ? 'card-part2-inside' : '' }}">
                        <span style="font-weight: bold; font-size: large">{{ $order->size }}L x {{ $order->qty }}</span>
                        <div class="card-part3 {{ $order->type == 'inside' ? 'card-part3-inside' : '' }}">
